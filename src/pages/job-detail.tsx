        ...
        <div className="max-w-5xl mx-auto px-4 py-6">
          ...
          {!job ? (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
              <h1 className="text-lg font-semibold text-gray-900 mb-2">Job not found</h1>
              <p className="text-sm text-gray-600 mb-4">The job details were not provided. Please return to the job list and open a job.</p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-start justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-sm text-gray-600">
                      ...
                      {job.paymentVerified && (
                        <div className="flex items-center gap-1"><CheckCircle className="h-4 w-4 text-purple-600" />Payment verified</div>
                      )}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button 
                    onClick={() => navigate('/resume-validation', { state: { job } })}
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
                <section>
                  <h2 className="text-sm font-semibold text-gray-900 mb-2">About this role</h2>
                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(job.tags as string[]).map((t: string, i: number) => (
                      <span key={i} className="bg-gray-100 text-gray-700 px-2 py-1 rounded-full text-xs">{t}</span>
                    ))}
                  </div>
                </section>
                ...
                <section className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700 list-disc pl-5">
                      <li>Create intuitive and user-friendly experiences across platforms.</li>
                      <li>Collaborate with cross-functional teams to drive product innovation.</li>
                      <li>Translate research into highly-polished visual designs.</li>
                      <li>Maintain and evolve design systems and documentation.</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-700 list-disc pl-5">
                      ...
                      <li>Strong proficiency with modern tools (e.g., Figma).</li>
                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {['Job_Requirement.pdf', 'Company_Benefits.pdf'].map((file) => (
                      <div key={file} className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-200 text-sm bg-gray-50">
