...
const SettingsPage: React.FC = () => {
  ...
  const [passwordSubTab, setPasswordSubTab] = useState<'change' | 'reset'>('change');
  ...
  const tabs: { id: SettingsTab; label: string }[] = [
    ...
    ...(isAdmin ? [{ id: 'integrations' as SettingsTab, label: 'Integrations' }] : []),
  ];
  ...
  const updateNotification = (category: keyof typeof notifications, type: 'push' | 'email' | 'sms', value: boolean) => {
        ...
        <CardContent className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('comments', 'push', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('comments', 'email', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('comments', 'sms', checked)}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('tags', 'push', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">Email</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('tags', 'email', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">SMS</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('tags', 'sms', checked)}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('reminders', 'push', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">Email</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('reminders', 'email', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">SMS</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('reminders', 'sms', checked)}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('activity', 'push', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">Email</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('activity', 'email', checked)}
            />
          </div>
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-700 dark:text-gray-300">SMS</span>
            <Switch
              ...
              onCheckedChange={(checked) => updateNotification('activity', 'sms', checked)}
            />
          </div>
        </CardContent>
      </Card>
    ...
    switch (activeTab) {
      case 'my-details':
        return (
          <div className="space-y-3">
            <div>
              <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">My Details</h2>
            </div>
            <Card>
              <CardHeader className="pb-2">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center gap-3 pb-2 border-b">
                  <div className="relative">
                    <div className="h-16 w-16 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center overflow-hidden border-2 border-gray-300 dark:border-gray-600">
                      {profileImage && profileImage !== 'https://via.placeholder.com/80' ? (
                        <img
                          src={profileImage}
                          alt="Profile"
                ...
                <div className="flex justify-end pt-1">
                  <Button size="sm" className="h-8 px-3 text-xs">Save Changes</Button>
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div className="space-y-1">
                    ...
                    <Input type="password" placeholder="Enter current password" className="h-8 text-xs" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-gray-700 dark:text-gray-300">New Password</label>
                    <Input type="password" placeholder="Enter new password" className="h-8 text-xs" />
                  </div>
                  <div className="space-y-1">
                  ...
                  <div className="flex justify-end pt-1">
                    <Button size="sm" className="h-8 px-3 text-xs">Update Password</Button>
                  </div>
                </CardContent>
              </Card>
            )}
